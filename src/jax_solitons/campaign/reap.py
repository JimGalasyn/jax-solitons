...
unscoped destroy needs --all; an unfiltered --label destroy needs --include-in-use.
  ...
  python -m jax_solitons.campaign.reap --label eps-farm --older-than 6h --yes  # safe
  python -m jax_solitons.campaign.reap --label eps-farm --include-in-use --yes # in-use too
